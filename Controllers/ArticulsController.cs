...
namespace PrettyNails.Controllers
{
    public class ArticulsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,Description,Type")] Articul articul)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price,Description,Type")] Articul articul)
        {
            if (id != articul.Id)
            {
                return NotFound();
